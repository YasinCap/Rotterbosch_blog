...
export async function getStaticProps() {
  ...
  // Hier wordt 'posts' gevuld door de get Entries functie, hij haalt hier alle entries op binnen de content soort post
  return {
    props: {
      posts: res.items,
    },
...
export default function Blogposts({ posts }) {
  ...
  return (
    <div className="container px-10 mb-8 rounded">
      <Navbar />
      <div className="relative bg-blue-50 px-4 pt-16 pb-20 sm:px-6 lg:px-8 lg:pt-24 lg:pb-28 ">
